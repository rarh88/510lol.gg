...
<style>
   .box2{width:900px; padding:80px; position:absolute;
      top: 580px; left:50%; transform: translate(-50%,-55%);
      background-color:#1a1d21; text-align:center; 
   }
...
<body>
<div class="box2">
   <form class="box" id="test" action="findUserRe" method='post'>
      <input type="text" name="nickname" id="nickname" placeholder="찾으실닉네임">
      <input type="submit" onclick="load()" value="찾기">
