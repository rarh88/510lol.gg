...
@Service
public class UserUpdateImpl implements Services{
   ...
   public void execute(Model model) {
      ...
      try{ 
         SearchnonDTO ffdto = sqlSession.selectOne(namespace+".findnonemember03", nick);
         System.out.println(ffdto.getMost1());
         // nickname 검색
         ...
         ddto.setNick(nick);
         ddto.setProfileiconid(profileIconId);
         ddto.setAccountid(accountId);
         ddto2.setNick(nick);
         ddto2.setProfileiconid(profileIconId);
         ddto2.setAccountid(accountId);
      ...
      // nickname으로 랭크, 티어 , 점수 출력   
         ...
         while((line2 = br2.readLine()) != null) { // 그 받아온 문자열을 계속 br에서 줄단위로 받고 출력하겠다.
            ...
            for(int j=0; j<mostC.size(); j++) {
               if(j==0) {
                  ...
                  tdto.setMost1(most1);
                  ddto.setMost1(most1);
                  ddto2.setMost1(most1);
               }else if(j==1){
                  most2 = mostC.get(j).getMost1();
                  sdto.setMost2(most2);
                  tdto.setMost2(most2);
                  ddto.setMost2(most2);
                  ddto2.setMost2(most2);
               }else if(j==2) {
                  most3 = mostC.get(j).getMost1();
                  sdto.setMost3(most3);
                  tdto.setMost3(most3);
                  ddto.setMost3(most3);
                  ddto2.setMost3(most3);
               }else if(j==3) {
                  most4 = mostC.get(j).getMost1();
                  sdto.setMost4(most4);
                  tdto.setMost4(most4);
                  ddto.setMost4(most4);
                  ddto2.setMost4(most4);
               }
               else if(j==4) {
            ...
            for(int i=0;i<leaguearr.size();i++) {
               ...
               if(leaguearr.get(i).getQueueType().equals("RANKED_SOLO_5x5")) {
                  ...
                  ddto.setTotal(total);
                  ddto.setWinrate(winrate);
                  ddto.setRank(leaguearr.get(i).getRank());
                  ddto.setTier(leaguearr.get(i).getTier());
                  ddto.setScore(leaguearr.get(i).getLeaguePoints());
                       ...
                       float fwinrate = (float)leaguearr.get(i).getWins()/total;
                        ...
                        ddto2.setTotal(total);
                        ddto2.setWinrate(winrate);
                        ddto2.setRank(leaguearr.get(i).getRank());
                        ddto2.setTier(leaguearr.get(i).getTier());
                        ddto2.setScore(leaguearr.get(i).getLeaguePoints());
                  }
               }
         ...
         for(int i=0; i<arr3.size(); i++) {
            ...
            System.out.println(k4.get("champion").getAsInt());
            System.out.println("--------"+sdto.getMost1());
         ...
         for(int z=0; z<5; z++) {
            System.out.println("111111111111"+umarr1.size());
            if(z==0) {
               ...
               mo1kda.setPrechamp(ffdto.getMost1());
               mo1kda.setNick(nick);
               ...
               sqlSession.update(namespace+".kdaMost1",mo1kda);
             ...
             model.addAttribute("smo1kda", mo1kda);
                  ...
                  String winrate =  String.format("%.2f", fwinrate);
                  MostDTO mo1kda = new MostDTO();
                  mo1kda.setPrechamp(ffdto.getMost2());
                  mo1kda.setNick(nick);
                  mo1kda.setChamp(sdto.getMost2());
                  mo1kda.setTotal(totalgame);
                  mo1kda.setWinrate(winrate);
                  mo1kda.setKda(kda);
                  
                  sqlSession.update(namespace+".kdaMost2",mo1kda);
                  model.addAttribute("smo2kda", mo1kda);
               ...
               String winrate =  String.format("%.2f", fwinrate);
               MostDTO mo1kda = new MostDTO();
               mo1kda.setPrechamp(ffdto.getMost3());
               mo1kda.setNick(nick);
               mo1kda.setChamp(sdto.getMost3());
               mo1kda.setTotal(totalgame);
               mo1kda.setWinrate(winrate);
               mo1kda.setKda(kda);
               
               sqlSession.update(namespace+".kdaMost3",mo1kda);
               model.addAttribute("smo3kda", mo1kda);
               ...
               String winrate =  String.format("%.2f", fwinrate);
               MostDTO mo1kda = new MostDTO();
               mo1kda.setPrechamp(ffdto.getMost4());
               mo1kda.setNick(nick);
               mo1kda.setChamp(sdto.getMost4());
               mo1kda.setTotal(totalgame);
               mo1kda.setWinrate(winrate);
               mo1kda.setKda(kda);
               
               sqlSession.update(namespace+".kdaMost4",mo1kda);
               model.addAttribute("smo4kda", mo1kda);
               ...
               String winrate =  String.format("%.2f", fwinrate);
               MostDTO mo1kda = new MostDTO();
               mo1kda.setPrechamp(ffdto.getMost5());
               mo1kda.setNick(nick);
               mo1kda.setChamp(sdto.getMost5());
               mo1kda.setTotal(totalgame);
               mo1kda.setWinrate(winrate);
               mo1kda.setKda(kda);
               System.out.println(sdto.getMost5());
               sqlSession.update(namespace+".kdaMost5",mo1kda);
               model.addAttribute("smo5kda", mo1kda);
               
            }
         }
            
         if(sdto.getQueuetype()!=null) {
              sqlSession.update(namespace+".nonmeberUp03", sdto);
              System.out.println("fiiiinish1");
             model.addAttribute("dto", ddto);
           }else if(sdto.getQueuetype()==null && tdto.getQueuetype()!=null) {
              sqlSession.update(namespace+".nonmeberUp03", tdto);
             System.out.println("fiiiinish2");
            model.addAttribute("dto", ddto2);
           }
